...
function [timemat, datmat, derivdat, derivdatHes] = and_CFD_datagen_mass_derivHes(init, tend, theta, sigV, num_timepts, rnsource, N)
   ...
   % derivdat2= datmat(:,:,num_timepts+1)*(diag(deriv_loglike.^2));
    ...
    derivdat12= datmat(:,:,num_timepts+1)*(diag(deriv_loglike.^2 +deriv_2nd_loglike ))  ;
